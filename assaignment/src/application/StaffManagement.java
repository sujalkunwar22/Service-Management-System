...
public class StaffManagement extends Application {
    ...
    private TableView<User> createUserTable() {
        ...
        roleColumn.setOnEditCommit(event -> {
            User user = event.getRowValue();
            user.setRole(event.getNewValue()); // Use the setRole method to update the role
            updateDatabase(user);
        });
    ...
    private void addUser() {
        ...
        // Add ComboBox to select role
        ComboBox<String> roleComboBox = new ComboBox<>();
        roleComboBox.getItems().addAll("Staff", "Customer");
        ...
        addButton.setOnAction(event -> {
            ...
            String role = roleComboBox.getValue(); // Get role from ComboBox
            ...
            User newUser = new User(id, name, address, email, phone, username, password, role, "Active");
        ...
        addUserDialog.getChildren().addAll(idField, nameField, addressField, emailField, phoneField, usernameField, passwordField, roleComboBox, addButton);
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("ALL STAFF MANAGER");
